    ...
    <div class="goodup-dashboard-nav sticky-top">
      <div class="goodup-dashboard-inner">
        <ul data-submenu-title="Main Navigation">
          ...
          <li><a href="dashboard-my-listings.php"><i class="lni lni-files me-2"></i>My Listings</a></li>
          <li><a href="dashboard-add-listing.php"><i class="lni lni-add-files me-2"></i>Add Listing</a></li>
        </ul>
